...
const source = readFileSync(new URL('./SuggestionsTab.tsx', import.meta.url), 'utf8');

describe('desktop companion suggestions pagination', () => {
  test('requests 10 suggestions by default and renders a controllable pager', () => {
